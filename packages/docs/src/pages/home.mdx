...
# Dripsy: The Design Graph Framework

Dripsy is a library for creating themeable user interfaces based on constraint-based design principles.
...
<View>
  <H1>This is react native!!!!! - Straight from dripsy inside of MDX</H1>
</View>
